...
pygame.display.set_caption("Menu de opciones")
...
rect_saludar = pygame.Rect(centro_x - button_width / 2, 100, button_width, button_height)
rect_brindar = pygame.Rect(centro_x - button_width / 2, 160, button_width, button_height)
rect_despedir = pygame.Rect(centro_x - button_width / 2, 220, button_width, button_height)
...
while running:
    for e in pygame.event.get():
        ...
        if e.type == MOUSEBUTTONDOWN:
            if e.button == 1:
                #Coordenadas donde se hizo click en la pantalla:
                cursor = e.pos
    ...
    crear_boton(screen, rect_saludar, "Saludar", background_color_button, background_color_button_hover)
    crear_boton(screen, rect_brindar, "Brindar", background_color_button, background_color_button_hover)
    crear_boton(screen, rect_despedir, "Despedir", background_color_button, background_color_button_hover)
